...
public record OverdriveStateS2CPayload(double effectiveMultiplier, boolean active) implements CustomPacketPayload {
	public static final Type<OverdriveStateS2CPayload> TYPE = new Type<>(ElytraOverdrive.id("state_v1"));
