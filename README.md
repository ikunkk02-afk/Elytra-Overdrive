...
- 原版鞘翅可直接放入附魔台生成正常三档选项；书架、经验和青金石消耗遵循原版规则。
...
原版鞘翅现在可以直接放入附魔台。默认附魔能力为 `10`，附魔台仍使用原版随机算法和候选过滤，因此可能获得 Overdrive、耐久或其他真正支持鞘翅且位于普通附魔台池中的附魔；不会保证每次出现 Overdrive，也不会让经验修补等宝藏附魔进入普通附魔台。
...
`elytraEnchantability=10` 控制原版鞘翅在附魔台中的附魔能力，允许范围为 1–30，并以服务器同步配置为准。
